...
import { SessionData, SessionMeta, ImageSize } from './types';
...
export const FormSection: React.FC<FormSectionProps> = ({ data, setData, isLoading, onSubmit }) => {
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="space-y-4 p-4 bg-indigo-50/50 rounded-lg border border-indigo-100/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="e.g. Be10x AI Career Accelerator"
                className="w-full px-3 py-2 bg-white border border-slate-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                value={data.meta.brand}
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Paste raw transcript, rough notes, or content generated from other tools..."
            value={data.transcript}
            onChange={(e) => handleTextChange('transcript', e.target.value)}
          />
        </div>
